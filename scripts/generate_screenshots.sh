...
# ------------------------------------------------------------------------------
log_step "3. Verifying Captured Screenshots in .github/assets/..."
# ------------------------------------------------------------------------------
COUNT=$(find .github/assets -type f -name "splash_*.png" | wc -l | tr -d ' ')
log_success "Captured $COUNT splash screenshots across locales."

find .github/assets -type f -name "splash_*.png" | sort
