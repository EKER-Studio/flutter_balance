...
class StepReminderNotification extends StatelessWidget {
  ...
  /// Toggles reminders via [AppSettingsBloc], which requests OS notification
  /// permission and schedules or cancels the daily reminder.
  void _handleToggle(BuildContext context, bool enabled) {
