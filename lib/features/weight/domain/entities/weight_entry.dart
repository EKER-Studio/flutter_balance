/// Represents an individual body weight measurement.
///
/// Encapsulates domain data for weight tracking: weight in kilograms,
/// measurement timestamp, and an optional user note. Values are expected
/// to lie within [minWeightKg] and [maxWeightKg] (inclusive).
class WeightEntry {
