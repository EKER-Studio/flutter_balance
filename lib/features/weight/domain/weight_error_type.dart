/// Represents a categorized failure mode in weight management workflows.
///
/// Emitted by weight domain logic and state management (e.g. BLoC) instead of
/// raw exception messages to decouple presentation layers from error strings
/// and enable type-safe localization.
