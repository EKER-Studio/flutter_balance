...
void main() {
  group('initial_weight_data', () {
    ...
    test('getInitial3MonthsWeightEntries contains days with multiple intraday measurements', () {
      final now = DateTime(2026, 7, 30, 10, 0);
      final entries = getInitial3MonthsWeightEntries(referenceDate: now);
      ...
      final daysWithMultipleEntries =
          dailyCounts.values.where((count) => count > 1);
